...
// source: github.com/bio-routing/bio-rd/cmd/multiris/api/ris.proto
...
import (
	...
	api2 "github.com/bio-routing/bio-rd/protocols/bgp/api"
...
const (
	...
	ObserveRIBRequest_IPv4IPv6Unicast ObserveRIBRequest_AFISAFI = 2
)
...
func (ObserveRIBRequest_AFISAFI) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{6, 0}
}
...
const (
	...
	DumpRIBRequest_IPv4IPv6Unicast DumpRIBRequest_AFISAFI = 2
)
...
func (DumpRIBRequest_AFISAFI) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{8, 0}
}

type Router_Source int32

const (
	Router_BMP Router_Source = 0
	Router_BGP Router_Source = 1
)

var Router_Source_name = map[int32]string{
	0: "BMP",
	1: "BGP",
}

var Router_Source_value = map[string]int32{
	"BMP": 0,
	"BGP": 1,
}

func (x Router_Source) String() string {
	return proto.EnumName(Router_Source_name, int32(x))
}

func (Router_Source) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{11, 0}
}
...
func (*LPMRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{0}
}
...
func (*LPMResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{1}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{2}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{3}
}
...
func (*GetLongerRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{4}
}
...
func (*GetLongerResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{5}
}
...
func (*ObserveRIBRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{6}
}
...
func (m *ObserveRIBRequest) GetNeighbor() string {
	if m != nil {
		return m.Neighbor
	}
	return ""
...
func (*RIBUpdate) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{7}
}
...
func (*DumpRIBRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{8}
}
...
func (m *DumpRIBRequest) GetNeighbor() string {
	if m != nil {
		return m.Neighbor
	}
	return ""
...
func (*DumpRIBReply) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{9}
}
...
func (*GetRoutersRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{10}
}
...
type Router struct {
	...
	Source               Router_Source `protobuf:"varint,4,opt,name=source,proto3,enum=bio.ris.Router_Source" json:"source,omitempty"`
	XXX_NoUnkeyedLiteral struct{}      `json:"-"`
	XXX_unrecognized     []byte        `json:"-"`
	XXX_sizecache        int32         `json:"-"`
}
...
func (*Router) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{11}
}
...
func (m *Router) GetSource() Router_Source {
	if m != nil {
		return m.Source
	}
	return Router_BMP
...
func (*GetRoutersResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{12}
}
...
func (m *GetNeighborsRequest) Reset()         { *m = GetNeighborsRequest{} }
func (m *GetNeighborsRequest) String() string { return proto.CompactTextString(m) }
func (*GetNeighborsRequest) ProtoMessage()    {}
func (*GetNeighborsRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{13}
}

func (m *GetNeighborsRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetNeighborsRequest.Unmarshal(m, b)
}
func (m *GetNeighborsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetNeighborsRequest.Marshal(b, m, deterministic)
}
func (m *GetNeighborsRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetNeighborsRequest.Merge(m, src)
}
func (m *GetNeighborsRequest) XXX_Size() int {
	return xxx_messageInfo_GetNeighborsRequest.Size(m)
}
func (m *GetNeighborsRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_GetNeighborsRequest.DiscardUnknown(m)
}

var xxx_messageInfo_GetNeighborsRequest proto.InternalMessageInfo

func (m *GetNeighborsRequest) GetRouter() string {
	if m != nil {
		return m.Router
	}
	return ""
...
func (m *GetNeighborsRequest) GetVrfId() uint64 {
	if m != nil {
		return m.VrfId
	}
	return 0
...
type GetNeighborsResponse struct {
	Neighbors            []*api2.Session `protobuf:"bytes,1,rep,name=neighbors,proto3" json:"neighbors,omitempty"`
	XXX_NoUnkeyedLiteral struct{}        `json:"-"`
	XXX_unrecognized     []byte          `json:"-"`
	XXX_sizecache        int32           `json:"-"`
}

func (m *GetNeighborsResponse) Reset()         { *m = GetNeighborsResponse{} }
func (m *GetNeighborsResponse) String() string { return proto.CompactTextString(m) }
func (*GetNeighborsResponse) ProtoMessage()    {}
func (*GetNeighborsResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_834dc2a623a072ae, []int{14}
}

func (m *GetNeighborsResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_GetNeighborsResponse.Unmarshal(m, b)
}
func (m *GetNeighborsResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_GetNeighborsResponse.Marshal(b, m, deterministic)
}
func (m *GetNeighborsResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_GetNeighborsResponse.Merge(m, src)
}
func (m *GetNeighborsResponse) XXX_Size() int {
	return xxx_messageInfo_GetNeighborsResponse.Size(m)
}
func (m *GetNeighborsResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_GetNeighborsResponse.DiscardUnknown(m)
}

var xxx_messageInfo_GetNeighborsResponse proto.InternalMessageInfo

func (m *GetNeighborsResponse) GetNeighbors() []*api2.Session {
	if m != nil {
		return m.Neighbors
	}
	return nil
...
func init() {
	...
	proto.RegisterEnum("bio.ris.Router_Source", Router_Source_name, Router_Source_value)
	...
	proto.RegisterType((*GetNeighborsRequest)(nil), "bio.ris.GetNeighborsRequest")
	proto.RegisterType((*GetNeighborsResponse)(nil), "bio.ris.GetNeighborsResponse")
}

func init() {
	proto.RegisterFile("github.com/bio-routing/bio-rd/cmd/multiris/api/ris.proto", fileDescriptor_834dc2a623a072ae)
}

var fileDescriptor_834dc2a623a072ae = []byte{
	// 777 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *routingInformationServiceClient) GetNeighbors(ctx context.Context, in *GetNeighborsRequest, opts ...grpc.CallOption) (*GetNeighborsResponse, error) {
	out := new(GetNeighborsResponse)
	err := c.cc.Invoke(ctx, "/bio.ris.RoutingInformationService/GetNeighbors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (*UnimplementedRoutingInformationServiceServer) GetNeighbors(ctx context.Context, req *GetNeighborsRequest) (*GetNeighborsResponse, error) {
...
func _RoutingInformationService_GetNeighbors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetNeighborsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(RoutingInformationServiceServer).GetNeighbors(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/bio.ris.RoutingInformationService/GetNeighbors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RoutingInformationServiceServer).GetNeighbors(ctx, req.(*GetNeighborsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _RoutingInformationService_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _RoutingInformationService_GetNeighbors_Handler,
		},
	},
	...
	Metadata: "github.com/bio-routing/bio-rd/cmd/multiris/api/ris.proto",
}
